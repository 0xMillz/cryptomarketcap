...
export class CreateExchanges1678402403641 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "exchanges"
                             (
                                 ...
                                 "apiUri"     character varying        NOT NULL,
                                 ...
                                 CONSTRAINT "UQ_6c64aff88339ab41158e38f4de9" UNIQUE ("slug"),
                                 CONSTRAINT "PK_17ccd29473f939c68de98c2cea3" PRIMARY KEY ("id")
                             )`);
    }
